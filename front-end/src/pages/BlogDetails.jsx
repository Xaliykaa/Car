...
import commentImg from "../assets/all-images/prof1.jpg";
          ...
          <Row>
            <Col lg="8" md="8">
              ...
              <div className="comment__list mt-5">
                <h4 className="mb-5">3 Сэтгэгдэл</h4>

                <div className="single__comment d-flex gap-3">
                  <img src={commentImg} alt="" />
                  <div className="comment__content">
                    <h6 className=" fw-bold">Batkalit_</h6>
                    <p className="section__description mb-0">31 ,March 2024</p>
                    <p className="section__description">
                      Их тус боллоо баярлалаа.
                    </p>
                ...
                <div className="leave__comment-form mt-5">
                  ...
                  <p className="section__description">
                    Сэтгэгдэл бичихийн тулд заавал нэвтэрч орсон байх ёстой.
                  </p>
            ...
            <Col lg="4" md="4">
              <div className="recent__post mb-4">
                <h5 className=" fw-bold">Шинэ Пост</h5>
              </div>
              {blogData.map((item) => (
